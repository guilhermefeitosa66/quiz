...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { correct: @choice.correct, description: @choice.description, question_id: @choice.question_id }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { correct: @choice.correct, description: @choice.description, question_id: @choice.question_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
